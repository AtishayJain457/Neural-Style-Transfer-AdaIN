...
#..\Intelligent-AI_Attendance\venv\Scripts\activate

def parse_arguments():
    parser = argparse.ArgumentParser()

    parser.add_argument('--content_dir', type=str, default=r'C:\coding\AI-ML course\Projects\Neural_style_transfer_with_AdaIN\NST_Code\content_data',
                        help='Location of content dataset')
    parser.add_argument('--style_dir', type=str, default=r'C:\coding\AI-ML course\Projects\Neural_style_transfer_with_AdaIN\NST_Code\style_data',
                        help='Location of style dataset')
    parser.add_argument('--vgg', type=str, default=r'C:\coding\AI-ML course\Projects\Neural_style_transfer_with_AdaIN\NST_Code\vgg_normalised.pth',
